...
import com.clevercloud.relaxng.program.EmptyItem;
...
import com.clevercloud.xml.QName;
import org.xml.sax.*;
...
public class VerifierHandlerImpl extends DefaultHandler
    ...
    *
    * @return <b>true</b> if the document was valid,
    *         <b>false</b> if not.
    * @throws IllegalStateException If this method is called before the endDocument event is dispatched.
    */
