...
package com.clevercloud.xml.readers;
   ...
   private int readSecond(int ch1)
      ...
      if ((ch1 & 0xe0) == 0xc0) {
         ...
         if (ch2 < 0)
            ...
            throw error(L.l("illegal utf-8 encoding {0}", hex(ch1)));
         ...
         if (ch2 < 0)
            ...
            throw error(L.l("illegal utf-8 encoding at {0} {1} {2}", hex(ch1), hex(ch2), hex(ch3)));

         if (ch3 < 0)
            throw new EOFException("unexpected end of file in utf-8 character");
         else if ((ch3 & 0xc0) != 0x80)
            throw error(L.l("illegal utf-8 encoding {0} {1} {2}",
         ...
         throw error(L.l("illegal utf-8 encoding at {0}", hex(ch1)));
   }
