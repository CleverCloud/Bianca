...
import com.clevercloud.bianca.lib.db.JavaSqlDriverWrapper;
 ...
 */
public class BiancaContext {

   private static L10N L = new L10N(BiancaContext.class);
   private static final Logger log = Logger.getLogger(BiancaContext.class.getName());
   ...
   private final BiancaSessionManager _sessionManager;
   ...
   private BiancaClass[] _classCacheMap = new BiancaClass[256];
   ...
   private LruCache<String, BiancaProgram> _evalCache = new LruCache<String, BiancaProgram>(4096);
   ...
   private String _phpVersion = BiancaVersion.getVersionNumber();
   ...
   public String getVersion() {
      return "Bianca " + BiancaVersion.getVersionNumber();
   }

   public String getVersionDate() {
      return BiancaVersion.getVersionDate();
   }
   ...
   private BiancaSessionManager createSessionManager() {
      return new BiancaSessionManager(this);
   }
   ...
   public BiancaSessionManager getBiancaSessionManager() {
   ...
   /**
    * Returns true if Bianca is running under Resin.
    */
  ...
  public static String mangleName(String name)
  {
   ...
   public final String getClassName(Path path) {
      ...
      return "_bianca." + mangleName(relPath);
   }
   ...
   public BiancaProgram parseCode(String code)
      ...
      if (program == null) {
         program = BiancaParser.parseEval(this, code);
   ...
   public BiancaProgram parseEvalExpr(String code)
      ...
      if (program == null) {
         program = BiancaParser.parseEvalExpr(this, code);
         _evalCache.put(code, program);
      }
    ...
    * Returns the undefined functions
    */
   public BiancaClass[] getClassCacheMap() {
    ...
    * Returns the undefined functions
    */
   public BiancaClass getCachedClass(int id) {
    ...
    * Returns the undefined functions
    */
   public void setCachedClass(int id, BiancaClass qClass) {
    ...
    */
   public BiancaClass getStdClass() {
