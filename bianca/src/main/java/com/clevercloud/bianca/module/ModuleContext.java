...
public class ModuleContext {
   ...
   /**
    * Scans the classpath for META-INF/services/com.clevercloud.bianca.BiancaModule
    */
   private void initStaticFunctions() {
      ...
      try {
         ...
         String biancaModule = "META-INF/services/com.clevercloud.bianca.BiancaModule";
         Enumeration<URL> urls = _loader.getResources(biancaModule);
   ...
   private void introspectPhpModuleClass(Class cl)
      ...
      synchronized (_moduleInfoMap) {
         ...
         log.log(Level.FINEST, "{0} loading module {1}", new Object[]{getClass().getSimpleName(), cl.getName()});

         BiancaModule module = (BiancaModule) cl.newInstance();
   ...
   /**
    * Scans the classpath for META-INF/services/com.clevercloud.bianca.BiancaClass
    */
   private void initStaticClassServices() {
      ...
      try {
         String biancaModule = "META-INF/services/com.clevercloud.bianca.BiancaClass";
         Enumeration<URL> urls = loader.getResources(biancaModule);
   ...
   private void initStaticClasses() {
      /*
      _stdClassDef = new InterpretedClassDef("stdClass", null, new String[0]);
      _stdClass = new BiancaClass(_stdClassDef, null);
      ...
      // BiancaClass exnCl = new BiancaClass(exn, null);
