...
public class IniDefinition {
    ...
    */
   public void set(BiancaContext bianca, Value value) {
      set(bianca.getIniMap(true), PHP_INI_SYSTEM, value);
   }

   /**
    * Set the ini value for the given scope.
    */
   public void set(BiancaContext bianca, String value) {
      set(bianca, new StringValue(value));
   }
   ...
   protected void set(HashMap<String, Value> map,
       ...
       * http://bugs.clevercloud.com/view.php?id=2095
   ...
   private Value get(HashMap<String, Value> envMap,
      ...
      if (value == null && biancaMap != null) {
         value = biancaMap.get(_name);
      }
    ...
    * it has not been set.
    */
   public Value getValue(BiancaContext bianca) {
      return get(null, bianca.getIniMap(false));
   }

   /**
    * Returns the value set for name, the first oof the local value set for the
    * environment, the global configuration value set for bianca, or the default
    * from the definition.
    *
    * @returns the value, or NullValue.NULL.
    */
   public Value getValue(Env env) {
      return get(env.getIniMap(false), env.getBianca().getIniMap(false));
   }

   public StringValue getAsStringValue(BiancaContext bianca) {
      return get(null, bianca.getIniMap(false)).toStringValue();
   }
   ...
   public boolean getAsBoolean(BiancaContext bianca) {
      return getAsBooleanValue(bianca).toBoolean();
   }
   ...
   public BooleanValue getAsBooleanValue(BiancaContext bianca) {
      return getAsBooleanValue(null, bianca.getIniMap(false));
   }
   ...
   public LongValue getAsLongValue(BiancaContext bianca) {
      return getAsLongValue(null, bianca.getIniMap(false));
   }
