...
/**
 * Stripped down version of com.clevercloud.server.session.SessionManager,
 * customized to PHP instead of J2EE sessions.
 */
public class BiancaSessionManager {

   private static final L10N L = new L10N(BiancaSessionManager.class);
   private static final Logger log = Logger.getLogger(BiancaSessionManager.class.getName());
