 ...
 * PHP HTTP functions
 */
public class HttpModule extends AbstractBiancaModule {

   private static final L10N L = new L10N(HttpModule.class);

   private static ArrayList<String> getHeaders(Env env) {
      ArrayList<String> headers = (ArrayList) env.getSpecialValue("clevercloud.headers");

      if (headers == null) {
         headers = new ArrayList<String>();
         env.setSpecialValue("clevercloud.headers", headers);
      }
