...
import com.clevercloud.bianca.annotation.ResourceType;
...
public class MysqliResult extends JdbcResultResource {
   ...
   protected Value fetchFieldImproved(Env env,
      ...
      try {
         ...
         switch (jdbcType) {
            case Types.DECIMAL:
               biancaType = MysqliModule.MYSQLI_TYPE_DECIMAL;
               break;
            case Types.BIT:
               ...
               if (mysqlType.equals("BIT")) {
                  biancaType = MysqliModule.MYSQLI_TYPE_BIT;
               } else {
                  biancaType = MysqliModule.MYSQLI_TYPE_TINY;
               }
               break;
            case Types.SMALLINT:
               biancaType = MysqliModule.MYSQLI_TYPE_SHORT;
               break;
            case Types.INTEGER: {
               if (!isInResultString(2, "medium")) {
                  biancaType = MysqliModule.MYSQLI_TYPE_LONG;
               } else {
                  biancaType = MysqliModule.MYSQLI_TYPE_INT24;
               }
               break;
            }
            case Types.REAL:
               biancaType = MysqliModule.MYSQLI_TYPE_FLOAT;
               break;
            case Types.DOUBLE:
               biancaType = MysqliModule.MYSQLI_TYPE_DOUBLE;
               break;
            case Types.BIGINT:
               biancaType = MysqliModule.MYSQLI_TYPE_LONGLONG;
               break;
            case Types.DATE:
               if (mysqlType.equals("YEAR")) {
                  biancaType = MysqliModule.MYSQLI_TYPE_YEAR;
               } else {
                  biancaType = MysqliModule.MYSQLI_TYPE_DATE;
               }
               break;
            case Types.TINYINT:
               biancaType = MysqliModule.MYSQLI_TYPE_TINY;
               break;
            case Types.TIME:
               biancaType = MysqliModule.MYSQLI_TYPE_TIME;
               break;
            case Types.TIMESTAMP:
               if (mysqlType.equals("TIMESTAMP")) {
                  biancaType = MysqliModule.MYSQLI_TYPE_TIMESTAMP;
               } else {
                  biancaType = MysqliModule.MYSQLI_TYPE_DATETIME;
               }
               break;
            case Types.LONGVARBINARY:
            case Types.LONGVARCHAR:
               biancaType = MysqliModule.MYSQLI_TYPE_BLOB;
               break;
            case Types.BINARY:
            case Types.CHAR:
               biancaType = MysqliModule.MYSQLI_TYPE_STRING;
               break;
            case Types.VARBINARY:
            case Types.VARCHAR:
               biancaType = MysqliModule.MYSQLI_TYPE_VAR_STRING;
               break;
            // TODO: may need to revisit default
            default:
               biancaType = MysqliModule.MYSQLI_TYPE_NULL;
               break;
         }

         result.putField(env, "type", LongValue.create(biancaType));
   ...
   protected Value getColumnString(Env env,
      ...
      if (rs instanceof BiancaResultSet) {
         BiancaResultSet qRs = (BiancaResultSet) rs;
