...
/**
 * Bianca class information
 */
public class ClassesModule extends AbstractBiancaModule {
   ...
   public boolean class_exists(Env env,
      ...
      BiancaClass cl = env.findClass(className, useAutoload, true);
   ...
   public String get_called_class(Env env) {
      ...
      if (qThis == null || qThis.getBiancaClass() == null) {
         env.warning("get_called_class was not called from a class method");
         return null;
      }

      return qThis.getBiancaClass().getName();
   }
   ...
   public static Value get_class_methods(Env env, Value cls) {
      ...
      if (cls.isObject()) {
         cl = ((ObjectValue) cls).getBiancaClass();
      } else {
   ...
   public static Value get_class_vars(Env env, Value obj) {
      ...
      if (obj instanceof ObjectValue) {
         cl = ((ObjectValue) obj).getBiancaClass();
      } else {
