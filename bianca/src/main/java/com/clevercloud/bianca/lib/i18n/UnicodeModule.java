...
public class UnicodeModule extends AbstractBiancaModule {
   ...
   public static final String ICONV_IMPL = "BiancaIconv";
   ...
   public static Value iconv_mime_decode_headers(Env env,
      ...
      try {
         ...
         throw new BiancaException(L.l("mime_decode requires javamail.jar"));
      }
   ...
   public static Value iconv_mime_decode(Env env,
      ...
      try {
         return BiancaMimeUtility.decodeMime(env, encodedHeader, charset);
      } catch (UnsupportedEncodingException e) {
         env.warning(e);
         log.log(Level.FINE, e.getMessage(), e);
