...
import com.clevercloud.vfs.StringWriter;
 ...
 */
public class VariableModule extends AbstractBiancaModule {
   ...
   public static boolean defined(Env env, String name) {
      ...
      if (i > 0) {
         ...
         BiancaClass cls = env.getClass(clsName);
   ...
   public static boolean is_callable(Env env,
      ...
      if (v instanceof StringValue) {
         ...
         if (obj instanceof StringValue) {
            ...
            BiancaClass cl = env.findClass(obj.toString());
            if (cl == null) {
               return false;
            }
