...
import com.clevercloud.bianca.lib.mail.MailModule;
...
public class MbstringModule
   ...
   public static Value mb_decode_mimeheader(Env env,
      ...
      try {
         return BiancaMimeUtility.decodeMime(env, str, encoding);
   ...
   public static StringValue mb_encode_mimeheader(Env env,
      ...
      try {
         String mime = BiancaMimeUtility.encodeMimeWord(str.toString(),
                 charset,
                 transfer_encoding,
                 linefeed,
                 76);
   ...
   public static Value mb_ereg_replace(Env env,
      ...
      if (eregValue.isLong()) {
         eregStr = StringValue.create((char) eregValue.toInt());
      } else {
   ...
   public static Value mb_eregi_replace(Env env,
      ...
      if (pattern.isLong()) {
         eregStr = StringValue.create((char) pattern.toInt());
      } else {
