 ...
 * PHP mysql routines.
 */
public class MysqlModule extends AbstractBiancaModule {
   ...
   public static boolean mysql_close(Env env, @Optional Mysqli conn) {
      ...
      if (isEnvConn || env.getSpecialValue("clevercloud.mysql") != null) {
         env.removeSpecialValue("clevercloud.mysql");
      }
   ...
   public static Value mysql_fetch_field(Env env,
      ...
      try {
         ...
         BiancaResultSetMetaData qMd = null;

         if (md instanceof BiancaResultSetMetaData) {
            qMd = (BiancaResultSetMetaData) md;
         }
   ...
   public static Value mysql_connect(
      ...
      /*
      String catalog = (String) env.getBianca().getSpecial("mysql.catalog");
      ...
      env.setSpecialValue("clevercloud.mysql", mysqli);
