...
public class Mysqli extends JdbcConnectionResource {
   ...
   protected ConnectionEntry connectImpl(Env env,
      ...
      try {
         ...
         if (driver == null || driver.equals("")) {
            if (env.getIniBoolean("bianca-mysql-driver")) {
               driver = "com.clevercloud.bianca.mysql.BiancaMysqlDriver";
            } else {
               driver = DRIVER;
            }
         }
         ...
         if (!(conn instanceof BiancaConnection)) {
   ...
   /**
    * Bianca function to get the field 'affected_rows'.
    */
   ...
   /**
    * Bianca function to get the field 'errno'.
    */
   public int geterrno() {
      return errno();
   }
   ...
   /**
    * Bianca function to get the field 'error'.
    */
   ...
   /**
    * Bianca function to get the field 'client_info'.
    */
   ...
   static StringValue getClientInfo(Env env) {
      String version = env.getBianca().getMysqlVersion();
   ...
   /**
    * Bianca function to get the field 'client_version'.
    */
   ...
   /**
    * Bianca function to get the field 'host_info'.
    */
   ...
   /**
    * Bianca function to get the field 'info'.
    */
   ...
   /**
    * Bianca function to get the field 'protocol_version'.
    */
   ...
   /**
    * Bianca function to get the field 'server_info'.
    */
   ...
   /**
    * Bianca function to get the field 'server_version'.
    */
   ...
   /**
    * Bianca function to get the field 'field_count'.
    */
   ...
   /**
    * Bianca function to get the field 'insert_id'.
    */
   ...
   /**
    * Bianca function to get the field 'sqlstate'.
    */
   ...
   /**
    * Bianca function to get the field 'thread_id'.
    */
   ...
   /**
    * Bianca function to get the field 'warning_count'.
    */
