 ...
 */
public class PostgresModule extends AbstractBiancaModule {
   ...
   public static boolean pg_close(Env env,
      ...
      try {
         ...
         if (conn == env.getSpecialValue("clevercloud.postgres")) {
            env.removeSpecialValue("clevercloud.postgres");
         }
   ...
   public static Postgres pg_connect(Env env,
      ...
      try {
         ...
         env.setSpecialValue("clevercloud.postgres", postgres);
...
//             "BER2col\tNUMBER3col\tNUMBER4col\t\\N\n";
   ...
   public static int pg_get_pid(Env env,
      ...
      try {
         ...
         String randomLabel = "clevercloud_pg_get_pid_random_label";
   ...
   public static ArrayValue pg_version(Env env,
      ...
      try {
         ...
         if (conn == null) {
            conn = (Postgres) env.getSpecialValue("clevercloud.postgres");
         }
   ...
   private static Postgres getConnection(Env env) {
      Postgres conn = (Postgres) env.getSpecialValue("clevercloud.postgres");
