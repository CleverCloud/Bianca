...
public class SessionModule extends AbstractBiancaModule
   ...
   public static String session_id(Env env, @Optional String id) {
      Value sessionIdValue = (Value) env.getSpecialValue("clevercloud.session_id");
      ...
      if (id != null && id.length() > 0) {
         env.setSpecialValue("clevercloud.session_id", env.createString(id));
      }
   ...
   public static boolean session_start(Env env) {
      ...
      env.setSpecialValue("clevercloud.session_id", env.createString(sessionId));
   ...
   static final IniDefinition INI_SESSION_SERIALIZE_HANDLER = _iniDefinitions.add("session.serialize_handler", "bianca", PHP_INI_ALL);
