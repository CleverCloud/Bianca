 ...
 * PHP image
 */
public class ImageModule extends AbstractBiancaModule {
   ...
   public static Value image_type_to_extension(int imageType, boolean dot) {
      ...
      throw new BiancaException("unknown imagetype " + imageType);
   }
    ...
    */
   public static AffineTransform image_get_transform(BiancaImage image) {
      if (image == null) {
         return null;
      }
    ...
    */
   public static long imagecolorat(BiancaImage image, int x, int y) {
    ...
    */
   public static long imagecolorclosest(BiancaImage image, int r, int g, int b) {
    ...
    */
   public static boolean imagecolordeallocate(BiancaImage image, int rgb) {
      // no-op
      return true;
   }
    ...
    */
   public static long imagecolorexact(BiancaImage image, int r, int g, int b) {
      return imagecolorallocate(image, r, g, b);
   }
    ...
    */
   public static long imagecolorresolve(BiancaImage image, int r, int g, int b) {
      return imagecolorallocate(image, r, g, b);
   }
    ...
    */
   public static ArrayValue imagecolorsforindex(BiancaImage image, int argb) {
   ...
   public static Value imagecreate(int width, int height) {
      BiancaImage image = new BiancaImage(width, height);
    ...
    */
   public static BiancaImage imagecreatefromgif(Env env, Path filename) {
    ...
    */
   @ReturnNullAsFalse
   public static BiancaImage imagecreatefromjpeg(Env env, Path filename) {
      try {
         return new BiancaImage(env, filename);
      } catch (Exception e) {
    ...
    * Create a new image from file or URL
    */
   public static BiancaImage imagecreatefrompng(Env env, Path filename) {
      return new BiancaImage(env, filename);
   }
    ...
    */
   public static BiancaImage imagecreatefromstring(Env env, InputStream data) {
      if (data == null) {
         return null;
      }

      return new BiancaImage(data);
   }

   /**
    * Create a new image from file or URL
    */
   public static BiancaImage imagecreatefromwbmp(Env env, Path filename) {
      return new BiancaImage(env, filename);
   }
    ...
    * Create a new image from file or URL
    */
   public static BiancaImage imagecreatefromxpm(Env env, Path filename) {
      return new BiancaImage(env, filename);
   }
   ...
   public static Value imagecreatetruecolor(int width, int height) {
      return new BiancaImage(width, height);
   }
    ...
    * Destroy an image
    */
   public static boolean imagedestroy(BiancaImage image) {
      // no-op
      return true;
   }
    ...
    * Flood fill
    */
   public static boolean imagefill(BiancaImage image, int x, int y, int color) {
   ...
   public static boolean imagefilter(Env env, BiancaImage image, int filterType,
      ...
      switch (filterType) {
         ...
         default:
            throw new BiancaException("unknown filterType in imagefilter()");
      }
   }
    ...
    */
   public static void imagegd2(BiancaImage image, @Optional Path file) {
      throw new BiancaException("imagegd2 is not implemented");
   }

   /**
    * Output GD image to browser or file
    */
   public static void imagegd(BiancaImage image, @Optional Path file) {
      throw new BiancaException("imagegd is not implemented");
   }
    ...
    */
   public static boolean imageistruecolor(BiancaImage image) {
      return true;
   }
    ...
    */
   public static boolean imagelayereffect(BiancaImage image, int effect) {
   ...
   public static long imageloadfont(Path file) {
      throw new BiancaException("imageloadfont() not implemented");
   }
   ...
   public static int imagepscopyfont(Value fontIndex) {
      throw new BiancaException("imagepscopyfont() not implemented");
   }
   ...
   public static boolean imagepsencodefont(Value fontIndex, Path encodingFile) {
      throw new BiancaException("imagepsencodefont() not implemented");
   }
   ...
   public static boolean imagepsextendfont(int fontIndex, float extend) {
      throw new BiancaException("imagepsextendfont() not implemented");
   }
   ...
   public static boolean imagepsfreefont(Value fontIndex) {
      throw new BiancaException("imagepsfreefont() not implemented");
   }
   ...
   public static Value imagepsloadfont(Path fontFile) {
      throw new BiancaException("imagepsloadfont() not implemented");
   }
   ...
   public static boolean imagepsslantfont(Value fontIndex, float slant) {
      throw new BiancaException("imagepsslantfont() not implemented");
   }
    ...
    */
   public static boolean imagesavealpha(BiancaImage image, boolean set) {
      // no-op since we currently only support true-color, full-alpha channel
      return true;
   }
    ...
    */
   public static boolean imagesetbrush(BiancaImage image, BiancaImage brush) {
    ...
    */
   public static boolean imagesetthickness(BiancaImage image, int thickness) {
    ...
    */
   public static int imagesx(@NotNull BiancaImage image) {
      if (image == null) {
         return 0;
      }
    ...
    */
   public static int imagesy(@NotNull BiancaImage image) {
      if (image == null) {
         return 0;
      }
   ...
   public static class BiancaImage extends ResourceValue {
      ...
      public BiancaImage(int width, int height) {
         _width = width;
         _height = height;
      ...
      public BiancaImage(InputStream inputStream) {
         try {
      ...
      public BiancaImage(Env env, Path filename) {
         try {
      ...
      public void setBrush(BiancaImage image) {
