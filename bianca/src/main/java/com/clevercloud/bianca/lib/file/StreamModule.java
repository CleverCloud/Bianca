 ...
 */
public class StreamModule extends AbstractBiancaModule {
   ...
   /**
    * stream_set_blocking is stubbed since Bianca should wait for
   ...
   static {
      _wrapperArray.append(new StringValue("bianca"));
