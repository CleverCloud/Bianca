 ...
 */
public class GoogleBiancaServletImpl extends BiancaServletImpl {

   private static final L10N L = new L10N(GoogleBiancaServletImpl.class);
   private static final Logger log = Logger.getLogger(GoogleBiancaServletImpl.class.getName());
   ...
   protected void initImpl(ServletConfig config)
      ...
      _bianca.setPwd(Vfs.lookup(_webApp.getRealPath(".")));
   }

   protected BiancaServletImpl getBiancaServlet() {
      return this;
   }
