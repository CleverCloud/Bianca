...
/**
 * Represents a Bianca runtime class.
 */
public final class BiancaClass extends NullValue {

   private static final L10N L = new L10N(BiancaClass.class);
   private static final Logger log = Logger.getLogger(BiancaClass.class.getName());
   private final JavaClassDef _javaClassDef;
   private final ClassDef _classDef;
   private final String _className;
   private BiancaClass _parent;
   private WeakReference<BiancaClass> _cacheRef;
   ...
   public BiancaClass(ModuleContext moduleContext,
      ...
      for (BiancaClass cls = parent; cls != null; cls = cls.getParent()) {
    ...
    */
   public BiancaClass(BiancaClass cacheClass, BiancaClass parent) {
      _cacheRef = new WeakReference<BiancaClass>(cacheClass);
   ...
   public void setModified() {
      if (!_isModified) {
         ...
         if (_cacheRef != null) {
            BiancaClass cacheClass = _cacheRef.get();
   ...
   public Value callNew(Env env, Value... args) {
      BiancaClass oldCallingClass = env.setCallingClass(this);
   ...
   private void getInterfaces(Env env, ArrayValue array,
      ...
      for (int i = 0; i < defList.length; i++) {
         ...
         for (int j = 0; j < defNames.length; j++) {
            BiancaClass cls = env.findClass(defNames[j]);
   ...
   Expr []args)
   {
   BiancaClass oldClass = env.setCallingClass(this);
   ...
   public boolean equals(Object o) {
      if (this == o) {
         return true;
      } else if (!(o instanceof BiancaClass)) {
         return false;
      }

      BiancaClass qClass = (BiancaClass) o;
