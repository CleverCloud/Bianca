...
public class ObjectExtValue extends ObjectValue
   ...
   public ObjectExtValue(BiancaClass cl) {
      super(cl);
   ...
   @Override
   protected void setBiancaClass(BiancaClass cl) {
      super.setBiancaClass(cl);
    ...
    */
   @Override
   public void initObject(Env env, BiancaClass cls) {
      setBiancaClass(cls);
   ...
   protected Value getFieldExt(Env env, StringValue name) {
      ...
      return _biancaClass.getField(env, this, name);
   }
   ...
   public Value putField(Env env, StringValue name, Value value) {
      ...
      if (entry == null) {
         ...
         if (!_isFieldInit) {
            AbstractFunction fieldSet = _biancaClass.getFieldSet();

            if (fieldSet != null) {
               _isFieldInit = true;
               Value retVal = _biancaClass.setField(env, this, name, value);
               _isFieldInit = false;
   ...
   public void unsetField(StringValue name) {
      Value returnValue = _biancaClass.unsetField(Env.getCurrent(), this, name);
   ...
   public void unsetArray(Env env, StringValue name, Value index) {
      // php/022b
      if (_biancaClass.getFieldGet() != null) {
         return;
      }
            ...
            if (entry._visibility == FieldVisibility.PRIVATE) {
               ...
               if (cls != _biancaClass) {
                  env.notice(L.l("Can't access private field '{0}::${1}'",
                     _biancaClass.getName(), name));
                  return null;
               }
            } else if (entry._visibility == FieldVisibility.PROTECTED) {
               BiancaClass cls = env.getCallingClass();

               if (cls == null || (cls != _biancaClass && !cls.isA(_biancaClass.getName()))) {
   ...
   public Iterator<Map.Entry<Value, Value>> getIterator(Env env) {
      TraversableDelegate delegate = _biancaClass.getTraversableDelegate();
   ...
   public Value callMethod(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethod(env, _biancaClass, this, args);
   }
   ...
   public Value callMethod(Env env, StringValue methodName, int hash) {
      ...
      return fun.callMethod(env, _biancaClass, this);
   }
   ...
   public Value callMethod(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethod(env, _biancaClass, this, a1);
   }
   ...
   public Value callMethod(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethod(env, _biancaClass, this, a1, a2);
   }
   ...
   public Value callMethod(Env env,
      ...
      return fun.callMethod(env, _biancaClass, this, a1, a2, a3);
   }
   ...
   public Value callMethod(Env env,
      ...
      return fun.callMethod(env, _biancaClass, this, a1, a2, a3, a4);
   }
   ...
   public Value callMethod(Env env,
      ...
      return fun.callMethod(env, _biancaClass, this, a1, a2, a3, a4, a5);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, args);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash) {
      ...
      return fun.callMethodRef(env, _biancaClass, this);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, a1);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, a1, a2);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, a1, a2, a3);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, a1, a2, a3, a4);
   }
   ...
   public Value callMethodRef(Env env, StringValue methodName, int hash,
      ...
      return fun.callMethodRef(env, _biancaClass, this, a1, a2, a3, a4, a5);
   }
   ...
   public Value clone(Env env) {
      ObjectExtValue newObject = new ObjectExtValue(_biancaClass);
   ...
   public StringValue toString(Env env) {
      AbstractFunction toString = _biancaClass.getToString();

      if (toString != null) {
         return toString.callMethod(env, _biancaClass, this).toStringValue();
      } else {
   ...
   public void varDumpImpl(Env env,
      ...
      if (isIncompleteObject()) {
         ...
         out.println("[\"__Bianca_Incomplete_Class_name\"]=>");
   ...
   public void cleanup(Env env) {
      BiancaClass qClass = getBiancaClass();
   ...
   public boolean issetField(StringValue name) {
      ...
      Value returnValue = _biancaClass.issetField(Env.getCurrent(), this, name);
      if (returnValue == UnsetValue.UNSET) {
