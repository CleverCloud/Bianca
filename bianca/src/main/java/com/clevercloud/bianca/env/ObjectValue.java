...
abstract public class ObjectValue extends Value {
   ...
   transient protected BiancaClass _biancaClass;
   ...
   protected ObjectValue(BiancaClass biancaClass) {
      _biancaClass = biancaClass;
      _className = biancaClass.getName();
   }
   ...
   public String getParentClassName() {
      return _biancaClass.getParentName();
   }
   ...
   public boolean isCallable(Env env) {
      return _biancaClass.getInvoke() != null;
   }
   ...
   public Value get(Value key) {
      ArrayDelegate delegate = _biancaClass.getArrayDelegate();
   ...
   public int getCount(Env env) {
      CountDelegate delegate = _biancaClass.getCountDelegate();
   ...
   public Value call(Env env, Value[] args) {
      AbstractFunction fun = _biancaClass.getInvoke();
