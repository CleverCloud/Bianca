...
abstract public class Value implements java.io.Serializable {
   ...
   /**
    * Returns the backing BiancaClass.
    */
    ...
    */
   public Value toKey() {
      throw new BiancaRuntimeException(L.l("{0} is not a valid key", this));
   }
    ...
    */
   public Value toLocalThis(BiancaClass qClass) {
      return this;
   }
