...
import com.clevercloud.vfs.i18n.EncodingWriter;
import com.clevercloud.vfs.i18n.ISO8859_1Writer;
import com.clevercloud.vfs.i18n.JDKReader;
import com.clevercloud.vfs.i18n.JDKWriter;
...
public class Encoding {
   ...
   * reader exists in com.clevercloud.vfs.i18n, use it.
   *
  ...
  public static EncodingReader getReadFactory(final String encoding)
    throws UnsupportedEncodingException
  {
    String encKey = encoding == null ? "utf-8" : encoding;
    ...
    if (factory == null) {
      try {
        ...
        String className = "com.clevercloud.vfs.i18n." + javaEncoding + "Reader";
  ...
  public static EncodingWriter getWriteEncoding(String encoding)
  {
    ...
    if (factory == null) {
      try {
        ...
        String className = "com.clevercloud.vfs.i18n." + javaEncoding + "Writer";
