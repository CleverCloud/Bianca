...
public abstract class Path {
    ...
    * <p/>
    * <p>e.g. for http://www.clevercloud.com/products/index.html, getTail()
    * returns 'index.html'
    */
   ...
   /**
    * Opens a bianca ReadStream for reading.
    */
   ...
   /**
    * Opens a bianca WriteStream for writing.
    */
   ...
   /**
    * Opens a bianca ReadWritePair for reading and writing.
    * <p/>
   ...
   /**
    * Opens a bianca stream for appending.
    */
