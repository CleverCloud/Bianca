...
public final class Vfs {
  private static final EnvironmentLocal<Path> ENV_PWD
    = new EnvironmentLocal<Path>("clevercloud.vfs.pwd");
  ...
  public static SchemeMap getLocalScheme()
  {
    synchronized (_localSchemeMap) {
      SchemeMap map = _localSchemeMap.get();
  ...
  {
    return com.clevercloud.vfs.StringReader.open(string);
  }
  ...
  {
    com.clevercloud.vfs.StringWriter s = new com.clevercloud.vfs.StringWriter(cb);
    WriteStream os = new WriteStream(s);
